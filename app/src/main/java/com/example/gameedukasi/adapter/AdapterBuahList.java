...
public class AdapterBuahList extends RecyclerView.Adapter<AdapterBuahList.ViewHolder> {

    private Context context;
    private List<ModelBuah> list;
    private MediaPlayer player;

    public AdapterBuahList(Context context, List<ModelBuah> list) {
    ...
    @NonNull
    @Override
    public AdapterBuahList.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater inflater = LayoutInflater.from(context);
        view = inflater.inflate(R.layout.card_list_item, parent, false);
        return new AdapterBuahList.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterBuahList.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
